...
def apply_ltspice_filter(simname,sig_in_x,sig_in_y,**kwargs):
  ...
  IR1 = ltr.get_trace("V(voutbeatpulses)")
  x = ltr.get_trace("time") 
  
  IR2 = ltr.get_trace("V(voutrateanalogue)")
  ...
  if IR2 is None:
    ...
    vout_x2 = abs(x2.get_wave(0))
    vout_y2 = IR2.get_wave(0)
  ...
  if interpol:
    ...
    if IR2 is None:
      ...
      f2 = interpolate.interp1d(vout_x2,vout_y2, fill_value="extrapolate")
      vout_x2 = sig_in_x
      vout_y2 = f2(sig_in_x)
  
  return (vout_x,vout_y,vout_y2)
